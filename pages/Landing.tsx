    ...
    try {
      ...
      setError(
        message.includes('Failed to fetch')
          ? 'Supabase 连接失败，请检查 VITE_SUPABASE_URL'
          : message
      );
    } finally {
      setLoading(false);
      ...
      <main className="relative z-10 w-full flex-grow flex items-center justify-center perspective-1000">
        {showLogin ? (
          ...
          <div className="relative w-full max-w-md h-[500px]">
            ...
            <div
              onClick={enterApp}
              className="absolute top-[18%] left-[50%] -translate-x-1/2 w-64 h-64 rounded-full animate-pulse-slow z-20 cursor-pointer
            ...
            >
              ...
              <div className="px-4 py-1 bg-white/20 rounded-full border border-white/40">
                <span className="text-white text-[10px] font-bold tracking-[0.2em]">点击进入</span>
              </div>
            </div>
