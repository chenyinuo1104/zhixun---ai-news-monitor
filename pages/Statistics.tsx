...
const Statistics: React.FC = () => {
  ...
  const trends: TrendItem[] = [
    { id: 1, rank: 1, name: '人工智能', volume: '98.4k', growth: 12, color: 'from-yellow-300 to-yellow-500' },
    { id: 2, rank: 2, name: '新能源车', volume: '85.2k', growth: 8, color: 'from-slate-300 to-slate-400' },
    { id: 3, rank: 3, name: '消费复苏', volume: '76.1k', growth: 0, color: 'from-orange-300 to-orange-400' },
    { id: 4, rank: 4, name: '全球贸易', volume: '54.2k', growth: -5, color: 'from-slate-100 to-slate-200' },
  ];
